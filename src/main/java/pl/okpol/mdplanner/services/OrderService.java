...
//        order.setComments("");
    ...
    public void updateOrder(Integer number, OrderDTO orderDTO) {
        ...
        if (order.getPallets() != orderDTO.getPallets()) {
...
//      Potrzebne jeśli wiązanie z inną tabelą FETCH.LAZY - dociąganie danych (do ustalenia czy w serwisie, czy w inne klasie
