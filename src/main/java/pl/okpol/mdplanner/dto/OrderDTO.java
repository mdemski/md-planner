...
public class OrderDTO {
    ...
    public OrderDTO(Integer offer, String reference, Integer number, String client, String system, String colour, Double units, Integer windows, Integer numberOfDoors, Integer slidings) {
        this.offer = offer;
